...
6. After submission to the DCPPC-RFC-Governance, DCPPC-RFC-Governance project management staff will move the document into a new folder in the shared DCPPC folder and promulgate widely, via email at broadcast@dcppc.groups.io, project-managers@dcppc.groups.io, and the NIH weekly email and via nih-dcppc.slack.com on the [general channel](https://nih-dcppc.slack.com/?redir=%2Fmessages%2FC7ULH1XRT) and [project manager channel](https://nih-dcppc.slack.com/messages/GA5DNEMF1) (“Distribution List”).  
