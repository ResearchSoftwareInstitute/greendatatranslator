...
setup(
      ...
      package_data={ 'greentranslator' : [ 'greentranslator/query/*.sparql' ]},
      version = '0.9',
      ...
      download_url = 'https://github.com/ResearchSoftwareInstitute/greendatatranslator/archive/0.9.tar.gz',
